...
white_check_row r c b_length rows
	...
	where
		...
		wR1	| r10diff < 0 		= head (drop c row1)
			| otherwise		= head (drop (c + 1) row1)
		wR2	| r20diff < 0		= head (drop c row2)
			| r20diff == 0		= head (drop (c + 1) row2)
			| otherwise		= head (drop (c + 2) row2)
		wL1	| r10diff < 0 		= head (drop (c - 1) row1)
			| otherwise		= head (drop c row1)
		wL2	| r20diff < 0		= head (drop (c - 2) row2)
			| r20diff == 0		= head (drop (c - 1) row2)
			| otherwise		= head (drop c row2)
...
black_check_row r c b_length rows
	...
	where
		...
		bR1	| r10diff < 0 		= head (drop c row1)
			| otherwise		= head (drop (c + 1) row1)
		bR2	| r20diff < 0		= head (drop c row2)
			| r20diff == 0		= head (drop (c + 1) row2)
			| otherwise		= head (drop (c + 2) row2)
		bL1	| r10diff < 0 		= head (drop (c - 1) row1)
			| otherwise		= head (drop c row1)
		bL2	| r20diff < 0		= head (drop (c - 2) row2)
			| r20diff == 0		= head (drop (c - 1) row2)
			| otherwise		= head (drop c row2)
